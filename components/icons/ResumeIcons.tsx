...
export const BriefcaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v-2.65c0-1.09-.893-1.983-1.983-1.983H5.733c-1.09 0-1.983.893-1.983 1.983v2.65M16.5 12.3H7.5m9-3.75H7.5M9 6.75h6M20.25 14.15A2.25 2.25 0 0118 16.4H6a2.25 2.25 0 01-2.25-2.25v-2.65" />
  </svg>
);
