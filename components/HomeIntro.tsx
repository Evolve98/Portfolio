...
const HomeIntro: React.FC<HomeIntroProps> = ({ id, data }) => {
  return (
    <section id={id} className="min-h-[calc(80vh-5rem)] flex items-center py-16 sm:py-20 bg-neutral-900 overflow-hidden"> {/* pt-20 from main is already there, adjust if needed */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-10 md:gap-16 items-center">
          ...
          <div className="md:col-span-2 text-center md:text-left order-2 md:order-1">
            <h1 
              className="text-4xl sm:text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500 mb-4 opacity-0 animate-fadeInUp animation-delay-100"
              style={{fontFamily: "'Poppins', sans-serif"}}
            >
              {data.greeting}
            </h1>
            <p className="text-xl sm:text-2xl text-neutral-300 mb-6 font-light opacity-0 animate-fadeInUp animation-delay-200">
              {data.introduction}
            </p>
            <div className="opacity-0 animate-fadeInUp animation-delay-300">
              <a
                href="#projects"
                onClick={(e) => {
                  e.preventDefault();
